...
operation::create-event[snippets='request-fields,curl-request,http-request,http-response,request-headers,http-response,response-headers,response-fields,links']
